  ...
  const groupBlock = (
    <div className="rounded-xl border border-sky-200 bg-sky-50 p-4 text-sm" dir="rtl">
      ...
      <p className="mt-1 text-xs text-sky-800">
        שמרו את שם הקבוצה הקיימת (למשל «משימות ארז»). אחרי חיבור הוואטסאפ יש שני מסלולים: שאלה מתחילה ב-בבי, למשל «בבי מה המשימות לשבוע הבא». משימה או הערה — בלי בבי, למשל «תכניס משימה יום רביעי שבוע הבא». בהקלדה אפשר גם * או ?.
      </p>
      <div className="mt-3 rounded-lg border border-sky-200 bg-white px-3 py-2 text-xs text-sky-950">
        ...
        <p className="mt-1 text-sky-800">
          כתבו «תפריט» בקבוצה — המערכת תשיב במספרים. שאלה חופשית חייבת להתחיל ב-בבי.
        </p>
        ...
        <p className="mt-2 text-sky-700">
          אם יש תגיות עבודה/לימודים יופיעו גם «עבודה מחר» וכו׳. דוגמה לשאלה: «בבי מה המשימות מחר בעבודה».
          משימה חדשה בלי בבי. לסימון: «בוצע 1».
        </p>
      </div>
