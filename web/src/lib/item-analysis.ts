...
const URGENCY_STYLES: Record<UrgencyLevel, string> = {
  גבוהה: "text-red-700 bg-red-50 border-red-200",
  בינונית: "text-amber-800 bg-amber-50 border-amber-200",
  נמוכה: "text-slate-600 bg-slate-50 border-slate-200",
  חסר: "text-slate-500 bg-slate-50 border-slate-200",
};
