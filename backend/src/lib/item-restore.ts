import type { ItemStatus } from "../types/database.js";
...
export function buildArchivePatch(item: ItemSnapshot): {
...
export function resolveRestoreFromArchivePatch(item: ItemSnapshot): {
  status: ItemStatus;
  metadata: Record<string, unknown>;
  completed_at: null;
  last_interacted_at: string;
...
export function buildSoftDeletePatch(item: ItemSnapshot): {
  deleted_at: string;
  metadata: Record<string, unknown>;
  last_interacted_at: string;
} {
...
export function resolveRestoreFromTrashPatch(item: ItemSnapshot): {
  deleted_at: null;
  metadata: Record<string, unknown>;
  last_interacted_at: string;
  status?: ItemStatus;
